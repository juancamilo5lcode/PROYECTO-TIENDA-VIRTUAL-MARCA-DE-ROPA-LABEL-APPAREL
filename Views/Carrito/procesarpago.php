						...
						<div id="optMetodoPago" class="notblock">	
							...
							<div class="divmetodpago">
								...
								<div id="divtipopago" class="notblock" >
									...
									<br>
									<button type="submit" id="btnComprar" class="flex-c-m stext-101 cl0 size-116 bg3-cambio bor14-cambio hov-btn3 p-lr-15 trans-04 pointer">Procesar pedido</button>
								</div>
								<style>
								.bor14-cambio {
									border-radius: 0px;
								...
								<div id="divpaypal">
									<div>
										<p>Por el momento solo manejamos pago contra entrega</p> 
									</div>
									<br>
