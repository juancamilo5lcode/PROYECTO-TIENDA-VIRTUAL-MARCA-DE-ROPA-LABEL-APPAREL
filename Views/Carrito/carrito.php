							...
							<?php 
							 ...
							 ?>
								<tr class="table_row <?= $idProducto ?>">
									...
									<td class="column-3"><?= SMONEY.formatMoney($producto['precio']) ?>COP</td><!--formatmoney-->
									<td class="column-4">
									...
									<td class="column-5"><?= SMONEY.formatMoney($totalProducto) ?>COP</td><!--formatmoney-->
								</tr>
							<?php } ?>
						...
						<div class="flex-w flex-t bor12 p-b-13">
							...
							<div class="size-209">
								<span id="subTotalCompra" class="mtext-110 cl2">
									<?= SMONEY.formatMoney($subtotal) ?><!--formatmoney-->
									COP</span>
							</div>
							...
							<div class="size-209">
								<span class="mtext-110 cl2">
									<?= SMONEY.formatMoney(COSTOENVIO) ?><!--formatmoney-->
									COP</span>
							</div>
						</div>
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="size-209 p-t-1">
								<span id="totalCompra" class="mtext-110 cl2">
									<?= SMONEY.formatMoney($subtotal + COSTOENVIO) ?><!--formatmoney-->
									COP</span>
							</div>
						</div>
						<a href="<?= base_url() ?>/carrito/procesarpago" id="btnComprar" class="flex-c-m stext-101 cl0 size-116 bg3-cambio bor14 hov-btn3 p-lr-15 trans-04 pointer">
							Procesar pago
						</a>
					</div>
				</div>
