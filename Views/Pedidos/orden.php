    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        <section id="sPedido" class="invoice">
          <div class="row mb-4">
            <div class="col-6">
              <h2 class="page-header"><img src="<?= media(); ?>/tienda/images/LABEL.png" style="width:50%;"></h2>
            </div>
            <div class="col-6">
          ...
          <div class="row invoice-info">
            ...
            <div class="col-4"><b>Orden #<?= $orden['idpedido'] ?></b><br> 
                ...
                <b>Monto:</b> <?= SMONEY.' '. formatMoney($orden['monto']) ?>COP
            </div>
          </div>
          <div class="row">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-right"><?= SMONEY.' '. formatMoney($producto['cantidad'] * $producto['precio']) ?>COP</td>
                  </tr>
                  <?php 
                            }
                        }
