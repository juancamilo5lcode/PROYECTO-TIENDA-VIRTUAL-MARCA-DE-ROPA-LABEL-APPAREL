						...
						<div class="filter-col4 p-b-27">
							...
							<div class="flex-w p-t-4 m-r--5">
								<?php 
								 ...
								 ?>
								<a href="<?= base_url() ?>/tienda/categoria/<?= $categoria['idcategoria'].'/'.$categoria['ruta'] ?>" class="flex-c-m stext-107 
								cl6 size-301 bor7 p-lr-15 hov-tag1 trans-04 m-r-5 m-b-5">
