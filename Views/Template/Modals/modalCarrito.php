...
<div class="w-full">
	...
	<div class="header-cart-buttons flex-w w-full">
		<a href="<?= base_url() ?>/carrito" class="flex-c-m stext-101 cl0 
		size-107 bg1-cambio bor1 hov-btn1 p-lr-15 trans-04 m-r-8 m-b-10">
			Ver carrito
		</a>

		<a href="<?= base_url() ?>/carrito/procesarpago" 
		class="flex-c-m stext-101 cl0 size-107 bg1-cambio bor1 hov-btn1 p-lr-15 trans-04 m-b-10">
			Procesar pago
		</a>
	</div>
</div>
