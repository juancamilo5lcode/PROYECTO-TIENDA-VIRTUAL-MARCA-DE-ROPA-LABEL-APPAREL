	...
	<table class="tbl-detalle">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-right"><?= SMONEY.' '.formatMoney($producto['precio']) ?>COP</td>
				<td class="text-center"><?= $producto['cantidad'] ?></td>
				<td class="text-right"><?= SMONEY.' '.formatMoney($importe) ?>COP</td>
			</tr>
			<?php } ?>
		</tbody>
		<tfoot>
			<tr>
				...
				<td class="text-right"><?= SMONEY.' '.formatMoney($subtotal) ?>COP</td>
			</tr>
			<tr>
				<td colspan="3" class="text-right">Envío:</td>
				<td class="text-right"><?= SMONEY.' '.formatMoney($orden['costo_envio']); ?>COP</td>
			</tr>
			<tr>
				<td colspan="3" class="text-right">Total:</td>
				<td class="text-right"><?= SMONEY.' '.formatMoney($orden['monto']); ?>COP</td>
			</tr>
		</tfoot>
	</table>
